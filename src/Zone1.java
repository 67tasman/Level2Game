...
Color color = new Color(100,81,71);
	...
	spaces[5][5].addInstruction(0, 		spaces[5][5], 	portal , color, true,     	0,    	true, 	7,   	8,		teleport);//portal 1 teleports player to portal 2
	...
	spaces[2][7].addInstruction(0, 		spaces[2][7], 	portal , color, true,     	0,    	true, 	7,   	2,		teleport);//portal 11 teleports to portal 10
	spaces[8][7].addInstruction(0, 		spaces[8][7], 	portal , color, true,     	0,    	true, 	4,   	7,		teleport);//portal 12 teleports to portal 13
	spaces[4][7].addInstruction(0, 		spaces[4][7], 	portal , color, true,     	0,    	true, 	8,   	7,		teleport);//portal 13 teleports to portal 13
	spaces[0][9].addInstruction(0,      spaces[4][9],   lock,    color, false,      1,      false,  0,      0,		null); //changes lock to state 1
